...
export function InnovationRequestProvider({ children, initialRequest }: { children: ReactNode; initialRequest: InnovationRequest }) {
  const [request, setRequest] = useState(initialRequest)

  return <InnovationRequestContext.Provider value={{ request, setRequest }}>{children}</InnovationRequestContext.Provider>
}
